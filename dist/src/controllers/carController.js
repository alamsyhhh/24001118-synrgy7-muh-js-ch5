...
const carServices_1 = __importDefault(require("../services/carServices"));
...
class CarController {
    getAllCars(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield carServices_1.default.getAllCars(res, category, name, page, pageSize);
            }
            catch (error) {
    ...
    getCarById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            carServices_1.default.getCarById(res, carId);
        });
    }
    createCar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newCar = yield carServices_1.default.createCar(req);
                if (newCar) {
    ...
    updateCar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const updatedCar = yield carServices_1.default.updateCar(req);
                if (updatedCar) {
    ...
    deleteCar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const carId = req.params.id;
            carServices_1.default.deleteCarById(res, carId);
        });
    }
}
